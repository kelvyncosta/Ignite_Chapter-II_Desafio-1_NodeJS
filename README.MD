...
Agora navegue até a pasta criada, abra no Visual Studio Code e execute o comando `yarn` ou `npm install` no seu terminal para instalar todas as dependências.
